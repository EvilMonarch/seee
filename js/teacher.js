...
if (localStorage.getItem('id') == "" || (localStorage.getItem('id')[0] == '5' || localStorage.getItem('id')[0] == '6')) {
...
function createSubject(namecourse, nameteacher, room, time, passcourse, day, num) {
  ...
  html += '<a onclick="ChooseFunction(5,' + num + ')"><div class="information information_btn" name="post" value="1">ลบนักศึกษา </div></a> '
  ...
  html += '<a onclick="ChooseFunction(4,' + num + ')"><div class="information information_btn" name="post" value="4">รายชื่อการลา</div></a>'
  html += '</div></div></div>'
